...
namespace UnityEssentials.Peek.Extensions.Editor
{
    ...
    public static class ExtSerializedProperties
    {
        ...
        public static bool TryFindField<T>(this UnityEngine.Object po, string name, out T value)
        {
            return po.TryFindField<T>(name, System.Reflection.BindingFlags.Default, out value);
        }

        public static bool TryFindField<T>(this UnityEngine.Object po, string name, System.Reflection.BindingFlags flags, out T value)
        {
            Type t = po.GetType();
            bool found = false;
            value = default(T);
        ...
        public static FieldInfo[] GetFieldsOfAllChilds(UnityEngine.Object target, System.Reflection.BindingFlags flags)
        {
            List<FieldInfo> fields = new List<FieldInfo>(20);
            Type t = target.GetType();

            do
            {
                FieldInfo[] allField = t.GetFields(flags);
                ExtSerializedProperties.Append(fields, allField.ToList());
        ...
        public static PropertyInfo[] GetPropertiesOfAllChilds(UnityEngine.Object target, System.Reflection.BindingFlags flags)
        {
            List<PropertyInfo> fields = new List<PropertyInfo>(20);
            Type t = target.GetType();

            do
            {
                PropertyInfo[] allField = t.GetProperties(flags);
                ExtSerializedProperties.Append(fields, allField.ToList());
